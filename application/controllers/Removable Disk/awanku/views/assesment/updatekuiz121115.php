 ...
 if(isset($_POST['submittrue']))
{
	   ...
	   #print_r($_FILES);
		...
		echo "insert into elearning_question set title_id='$id', question='$truefalse', answer_one='$answerone', answer_two='$answertwo', correct_answer='$correctanswer', question_type = '$question_type', picture='$file_content'";
		die();
...
<br>
	...
	<table width="85%">
		<tr>
			...
			<td colspan="2"><strong><?php echo $data['title']; ?><a href="<?php echo base_url('index.php/assesment_control/updatetitle?cid='.$data["title_id"].''); ?>" rel="gb_page_center[500, 500]" target="_blank"><img src ="<?php echo $base; ?>/images/edit2.png" width = "30" height = "30"/></a></strong></td>
		</tr>
...
?>
   ...
   <tr>
 	  ...
 	  echo '<img src="data:image/jpeg;base64,' . base64_encode($row['picture']) . '" width="200"/>' ;
		...
		<center><?php echo $row['question']; ?></center></td>
