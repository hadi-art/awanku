...
<div style="float:right; position:absolute; left:70; top:90; width:60%; height:100%">
  <iframe width="60%" height="80%" src="<?php echo $site."/studioclass_control/viewattendance_ajax/?cid=$id";?>"></iframe>
</div>

<div class="camera" style="float:left; width:40%; position:absolute; right:170;">
&nbsp;<br><br><br><br>
