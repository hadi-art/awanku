...
<input type="checkbox" id="css3menu-switcher" class="switchbox"><label onclick="" class="switch" for="css3menu-switcher"></label>	
	<li class="topfirst"><a href="<?php echo $site."/studioclass_control";?>" style="height:32px;line-height:32px;"><img src="<?php echo $base; ?>images/1studioclass.png" width="32" height="32" alt=""/>StudioClassroom</a></li>
...
<!------------------------------------------------end menu bar-----------------------------------------------------------------	-->	</td>
	...
	<td>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo $site."/studioclass_control"; ?>"><img src="<?php echo $base; ?>images/1studioclass.png" alt="K tube" width="100" height="60"/></a></td>
  </tr>
  <?php /*?><tr>
    <td>&nbsp;</td>
