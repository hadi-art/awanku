...
<li><a onClick="goBack()" style="height:34px;line-height:34px; text-align:center; width:45px;cursor:pointer;"><img src="<?php echo $base."include/menubar/"; ?>menubar_files/css3menu1/256base-redo.png" width="35px" height="35px"  alt="Undo"/>&nbsp 
	...
	<li><a onClick="goForward()" style="height:34px;line-height:34px; text-align:center; width:45px;cursor:pointer;"><img src="<?php echo $base."include/menubar/"; ?>menubar_files/css3menu1/256base-rundo.png" width="35px" height="35px" alt="Redo"/>&nbsp 
       ...
       <li class='active has-sub'><a style="height:34px;line-height:34px; text-align:center; width:45px;cursor:pointer;"><span>Content</span></a> 
      <ul>
    ...
    <li class='active has-sub'><a href='#' style="height:34px;line-height:34px; text-align:center; width:55px;cursor:pointer;"><span>PT3</span></a> 
      <ul>
        <?php
	...
	?>
	 ...
	 <li><a href="<?php echo $site."/ktube_control/steam/0/0/0"?>" style="height:34px;line-height:34px; text-align:center; width:55px;cursor:pointer;">STEAM</a></li>
	
	
	
         
    <li class='active has-sub'><a href='#' style="height:34px;line-height:34px; text-align:center; width:100px;cursor:pointer;"><img src="<?php echo $base."include/menubar/"; ?>menubar_files/css3menu1/service.png" width="24px" height="24px" alt=""/><?php echo $_SESSION["log"]["fullname"]; ?></a> 
      <ul>
