...
<ul>
   ...
   <li class='active has-sub'><a href='#' style="height:24px;line-height:24px;"><span>Content</span></a>
       <ul>
    <li><a href="<?php echo $site."/ktube_control/contentlist/0/0/0"?>" style="height:32px;line-height:32px; text-align:left;">All Content</a></li>
	<li><a href="<?php echo base_url('index.php/ktube_control/sourceview')?>" style="text-align:left;">Resource Summary</a></li>
    	</ul>
         </li>
   ...
   <li class='active has-sub'><a href='#' style="height:24px;line-height:24px;"><img src="<?php echo $base."include/menubar/"; ?>menubar_files/css3menu1/service.png" width="24px" height="24px" alt=""/><?php echo $_SESSION["log"]["fullname"]; ?></a>
		<ul>
		<li><a href="<?php echo $site."/ktube_control/mydocument"?>" style="text-align:left;">My Files</a></li>
