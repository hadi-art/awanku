...
<input type="checkbox" id="css3menu-switcher" class="switchbox"><label onclick="" class="switch" for="css3menu-switcher"></label>	
	<li class="topfirst"><a href="<?php echo $site."/lessonplan_control/planlesson_subject/?cid=$class";?>" style="height:32px;line-height:32px;"><img src="<?php echo $base; ?>/images/lessonplan.png" width="32" height="32" alt=""/>Lesson Plan</a></li>
...
<!------------------------------------------------end menu bar-----------------------------------------------------------------	-->	</td>
	...
	<td>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="<?php echo $base; ?>images/lessonplan.png" alt="K tube" width="100" height="60"/></td>
  </tr>
  <?php /*?><tr>
    <td>&nbsp;</td>
