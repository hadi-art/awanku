...
?>
<a href="<?php echo $site."/lessonplanner_control/add_plan/0/$sem/$week/$subject/add" ?>" title="Add :<?php echo view_subject($subject); ?>" rel="gb_page_center[700, 450]"><img src ="<?php echo $base; ?>/images/document_add.png" width = "25" height = "25"/></a>Add
