...
?>
	...
	<li><a href="<?php echo $site."/lessonplan_control";?>" style="height:24px;line-height:24px;"><img src="<?php echo $base; ?>images/lessonplan.png" width="34px" height="34px" alt=""/></a>
	</li>
