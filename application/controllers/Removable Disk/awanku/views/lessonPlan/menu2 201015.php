...
<ul>
    ...
    <li class="has-sub"><a style="height:34px;line-height:34px;width:150px;text-align:center; width:120px;cursor:pointer;"><img src="<?php echo $base."include/menubar/"; ?>menubar_files/css3menu1/kipas.png" width="65px" alt=""/> </a>
      <ul>
		...
		<li><a href="<?php echo $site."/lessonplan_control/studentquiz/?cid=$class";?>" style="height:34px;line-height:34px;width:137px;text-align:center;cursor:pointer;"><img src="<?php echo $base; ?>images/1assess.png"  width="40px" alt=""/>Quizes</a>
 <?php /*   
<?php
