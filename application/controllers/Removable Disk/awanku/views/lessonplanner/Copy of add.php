...
if(isset($_POST['edit']))
{
	...
	$file=$_POST['file'];
  	...
  	$sqll ="update ilearn_content set upload_id ='$upload_id',subject_id ='$subject_id', file_id='$idcontent', topic ='$topic', objective ='$objective', 
	activity ='$activity', outcome ='$outcome', flag ='1',week='$_POST[week]' where id='$id'";
	//die();
...
<tr>
	<td>
		...
		$q="SELECT id, name FROM tbl_classlist";
		$name=mysql_query($q);
