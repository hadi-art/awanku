...
<tr> 	  	
			...
			{
		?>
			<li><a href ="<?php echo "$base".getpath($qq[$i]); ?>" style="color:#FF00FF"><?php echo gettitle($qq[$i]);?></a></li>
			<br>	
		<?php
			}
		?>
		...
		?>
			<li>Quiz Title : <a href="<?php echo base_url('index.php/lessonplanner_control/viewquestion/?cid='.$qz[$a].''); ?>"  rel="gb_page_center[900, 600]" target="_blank"><?php echo getquiz($qz[$a]);?></a></li>
			<br>	
		<?php
			}
		?>
