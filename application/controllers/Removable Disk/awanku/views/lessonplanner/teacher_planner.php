...
echo $q="INSERT INTO ilearn_content
(upload_id,subject_id,file_id,topic,objective,activity,outcome,class_id,sem,WEEK,MONTH,DATE,datePost,Ftime,Ttime,flag,quiz_id,global_context,concept,inquiry,approaches,existing_knowledge,
...
<a href="<?php echo $site."/lessonplanner_control/add_plan/0/$sem/$week/$subject/add" ?>" title="Add :<?php echo view_subject($subject); ?>" target="_blank"><img src ="<?php echo $base; ?>/images/document_add.png" width = "25" height = "25"/>Add</a>
...
?>
		...
		<a href="<?php echo "$site/lessonplanner_control/edit_plan/$row[id]/$sem/$week/$subject/edit";?>" title="Edit :<?php echo view_subject($subject); ?>"><img src ="<?php echo $base; ?>/images/edit2.png" width = "40" height = "40"/></a>
