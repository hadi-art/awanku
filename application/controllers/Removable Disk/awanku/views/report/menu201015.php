...
<ul>
	...
	<li class="has-sub"><a style="height:34px;line-height:34px; text-align:center; width:120px;cursor:pointer;"><img src="<?php echo $base."include/menubar/"; ?>menubar_files/css3menu1/service.png" width="32px" height="32px"  alt=""/><?php echo $_SESSION["log"]["fullname"]; ?></a>
		<ul>
