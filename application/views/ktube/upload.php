...
<div class="upload" style="background-color:#FFFFFF; width:50%; height:48%">
<br>
...
<table align="center" cellpadding="4%" cellspacing="4%"> 
	...
	<tr>
		      	<td>File</td><td> : </td><td><input size="10000" capture="file" name="file" type="file" id="file"></td>
	</tr> 
...
<div class="progress">
    ...
    <div id="status2">Please Wait Until Page Return to MyFile . . </div>
