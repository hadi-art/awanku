...
<?php /*?>        <th style="padding:4px;"><span>IB Profile</span></th>
<?php */?>       
		<th style="padding:4px;"><span>Form</span></th>
...
<?php /*?>  <td style="padding:4px;"><?php echo getnama($data["profile_id"],"profile","ktube_ibprofile","profile_id"); ?></td>
<?php */?>  
  <td class="lalign" style="padding:4px;"><center><?php echo $data["form"]; ?></center></td>
