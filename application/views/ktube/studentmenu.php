...
<?php /*?>	<li class="topfirst"><a href="<?php echo $site."/ktube_control";?>" style="height:32px;line-height:32px;"><img src="<?php echo $base; ?>images/1a_ktube.jpg" width="32" height="32" alt=""/>KTube</a></li><?php */?>
	...
	<li class="topmenu">
   <a style="height:32px;line-height:32px;"><span>Content</span></a>
    <ul>
    <li><a href="<?php echo $site."/ktube_control/contentlist/0/0/0"?>" style="height:32px;line-height:32px;">All Content</a></li>
	<li><a href="<?php echo base_url('index.php/ktube_control/sourceview')?>">Resource Summary</a></li>
    </ul>
	</li>
	<li class="topmenu">
	<a style="height:32px;line-height:32px;"><span>SPM</span></a>
	...
	?>
	<li><a href="<?php echo $site."/ktube_control/contentlist/$data[id]/0/2"?>"><?php echo $data["subject"]; ?></a>
	...
	<li class="topmenu"><a style="height:32px;line-height:32px;"><span>PT3</span></a>
	<ul>
	<?php
	...
	<li><a href="<?php echo $site."/ktube_control/contentlist/$data[id]/0/1"?>"><?php echo $data["subject"]; ?></a>
	<!--tahap =1 adalah pmr-->
	<!--ibprofile=0 adalah semua ib-->
	<!-----sub sub menu----------------------------------------------------------------------------->
			<?php /*?><ul>
	...
	<li class="topmenu"><a href="<?php echo $site."/ktube_control/steam/0/0/0"?>" style="height:32px;line-height:32px;"><span>STEAM</span></a>
	...
	<li class="toplast"><a href="#" style="height:32px;line-height:32px;"><img src="<?php echo $base."include/menubar/"; ?>menubar_files/css3menu1/service.png" alt=""/><?php echo $_SESSION["log"]["fullname"]; ?></a>
		<ul>
		<li><a href="<?php echo $site."/ktube_control/mydocument"?>">My Files</a></li>
		<li><a href="<?php echo $site."/ktube_control/upload"?>">Upload</a></li>
...
<!------------------------------------------------end menu bar-----------------------------------------------------------------	-->	</td>
	...
	<td>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo $site."/ktube_control"; ?>"><img src="<?php echo $base; ?>images/1a_ktube.jpg" alt="K tube" width="100" height="60"/></a></td>
  </tr>
  <?php /*?><tr>
    <td>&nbsp;</td>
