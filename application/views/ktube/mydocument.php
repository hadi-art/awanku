...
?>
<br>
<div id="tablektube" style="width:73%">
...
<td>
<!-- <a href="<?php echo $site;?>/ktube_control/edit?id=<?php //echo $data["id"]; ?>" onClick="window.open(this.href, 'child', 'scrollbars,width=950,height=600'); return false"><img src ="<?php //echo $base; ?>/images/edit2.png" width = "30" height = "30"/></a> -->

<a href="<?php echo base_url('index.php/ktube_control/edit?id='.$data["id"].''); ?>" rel="gb_page_center[700, 500]" target="_blank"><img src ="<?php echo $base; ?>/images/edit2.png" width = "30" height = "30"/></a>
