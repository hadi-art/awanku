...
<?php 
	...
	<table height="32" style="width:80%; float:center">
<form method="post" action="">
	<tr>
		<td width="793" height="26" align="center"><input type="text" name="search" id="searchid" placeholder="Search for content" required>
		<?php /*?><td width="69" align="center"><input type="submit" name="submitsearch" value="Search" id="submit"></td><?php */?>
	</tr>
	</form>
</table>
<br />
...
<form method="post" action="">
<tr>
<td colspan="2"><center><?php echo $result; ?> <b><?php echo $search;?></b></center>
</td>
</tr>
	<tr>
		<td width="793" height="26" align="center"><input type="text" name="search" id="searchid" placeholder="Search for content" required>
		...
		<?php /*?><td width="69" align="left"><input type="submit" name="submitsearch" value="Search" id="submit"></td><?php */?>
	</tr>
	</form>
</table>
<br />
...
?>	
	<tr>
		...
		<td><a href="<?php echo base_url('index.php/ktube_control/teacherfile/?teacherid='.$runrows["upload_by"].'')?>"><?php echo getupload($upload) ?></a></td>
