...
<?php */?>	
    <li class="has-sub"><a href="<?php echo $site."/awanku_control/"?>" style="height:34px;line-height:34px;width:150px;text-align:center; width:100px;cursor:pointer;"><img src="<?php echo $base."include/menubar/"; ?>menubar_files/css3menu1/kipas.png" width="65px" alt=""/> </a>
     <ul> <?php if ($uid=='699'){ ?>
             <li><a href="<?php echo $site."/lessonplanner_control/lessonPlannerTeacher/1/1/$year"?>"  style="text-align:left; width:100px;">Teacher</a></li><?php } ?>
...
{ echo "class='active '";} ?>>
<a href='<?php echo $site."/lessonplanner_control/teacher_planner/1/$sem/$subject/$y";?>' title="<?php echo $data["year"]; ?>"><span><?php echo $y; ?></span></a>
</li>
...
<a href='<?php echo $site."/lessonplanner_control/teacher_planner/1/$sem1[week]/$subject/$yr";?>' title="<?php echo $sem1["sem"]; ?>"><span><?php echo $menu_nama; ?></span></a>
</li>
...
<li <?php if($klik1==$sem1['week']){ echo "class='active '";} ?>>
<a href='<?php echo $site."/lessonplanner_control/teacher_planner/2/$sem1[week]/$subject/$yr";?>' title="<?php echo $sem1["sem"]; ?>"><span><?php echo $menu_nama; ?></span></a>
</li>
