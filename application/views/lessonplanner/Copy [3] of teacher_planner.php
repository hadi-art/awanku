...
<thead>
<tr>
	<th width="40"><center>Date </center></th>
	<th width="50"><center>Time </center></th>
	<th width="68"><center>T.Name </center></th>
    <th width="44"><center>Class </center></th>
	<th width="44"><center>Topic</center></th>
	<th width="77"><center>Objective</center></th>
	<th width="62"><center>Activity</center></th>
	<th width="72"><center>Outcome</center></th>
	<th width="60"><center>Files</center></th>
	<th width="72"><center>Action</center></th>
 </tr>
</thead>
<tbody> 
<?php
...
<a href="<?php echo "$site/lessonplanner_control/add_plan/$row[id]/$sem/$week/$subject/edit";?>" title="Edit :<?php echo view_subject($subject); ?>" rel="gb_page_center[700, 700]"><img src ="<?php echo $base; ?>/images/edit2.png" width = "40" height = "40"/></a>
 ...
 <a onClick="return confirm('Pasti Untuk Padam?')"  href="?delete=<?php echo $row["id"]; ?>"><img src ="<?php echo $base; ?>/images/delete.png" width = "30" height = "30"/></a>			   
	 ...
	 <ul>
		...
		{
		?>
		<a href="<?php echo base_url('index.php/lessonplanner_control/studentmark/?cid='.$qz[$i].'&classid='.$classid.''); ?>" title="<?php echo getquiz($qz[$i]);?>" rel="gb_page_center[900, 700]" target="_blank"><img src ="<?php echo $base; ?>/images/icon_scorecard3.png" width = "40" height = "40"/></a>
		<br>	
		<?php
		}
		?>
