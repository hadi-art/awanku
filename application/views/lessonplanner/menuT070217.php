...
<div id="cssmenu">
<ul>
<?php /*?>	<li><a href="<?php echo $site."/awanku_control/"?>" style="height:34px;line-height:34px;width:100px;text-align:center;cursor:pointer;"><img src="<?php echo $base."include/menubar/"; ?>menubar_files/css3menu1/home.png"  width="40px" alt=""/></a> </li>
<?php */?>	
    <li class="has-sub"><a href="<?php echo $site."/awanku_control/"?>" style="height:34px;line-height:34px;width:150px;text-align:center; width:100px;cursor:pointer;"><img src="<?php echo $base."include/menubar/"; ?>menubar_files/css3menu1/kipas.png" width="65px" alt=""/> </a>
     <ul>
	<li><a href="<?php echo $site."/lessonplanner_control/lessonPlannerTeacher"?>"  style="text-align:left; width:100px;">Teacher</a></li>
        <li><a href="<?php echo $site."/lessonplanner_control/plannerlesson_subject"?>"  style="text-align:left; width:100px;">Subject</a></li>
         <?php /*?>
	...
	<li><a href="<?php echo $site."/lessonplanner_control/plannerlesson_subject";?>" style="height:34px;line-height:34px; text-align:center; width:137px;cursor:pointer;"><img src="<?php echo $base; ?>images/lessonplanner.png"width="34px" height="34px" alt=""/></a></li>
...
<table border="0">
  ...
  <tr>
    ...
    <td>
		...
		<!--------------------------------------------------------year----------------------------------------------------------------------->
<link rel="stylesheet" type="text/css" href="<?php echo $base; ?>include/menu_assets/styles2.css" />	


<div id='cssmenu2' style=" width:100%;">
<ul>
<?php

$yr = $year;

$q4=mysql_query("select * from ilearn_year where flag =1");
...
<li <?php if($yr == $data['year'])

{ echo "class='active '";} ?>>
<a href='<?php echo $site."/lessonplanner_control/planner_teacher/1/$sem/$uuid/$y";?>' title="<?php echo $data["year"]; ?>"><span><?php echo $y; ?></span></a>
</li>
...
#sprintf('%08d', 1234567);
			...
			$q="SELECT week, approve_status FROM ilearn_content WHERE flag='1' AND upload_id='$uuid' AND approve_status ='3' AND sem='1'";
					list($wee,$stat)=mysql_fetch_row(mysql_query($q));
                    				
				if ($wee == $menu_nama && $stat=='3')
				{

?>

<li <?php if($klik1==$sem1['week']){ echo "class='active '";} ?>>
<a href='<?php echo $site."/lessonplanner_control/planner_teacher/1/$sem1[week]/$uuid/$yr";?>' title="<?php echo $sem1["sem"]; ?>"><span style="color:#F00"><?php echo $menu_nama; ?></span></a>
</li>
...
<?php
					...
					<li <?php if($klik1==$sem1['week']){ echo "class='active '";} ?>>
<a href='<?php echo $site."/lessonplanner_control/planner_teacher/1/$sem1[week]/$uuid/$yr";?>' title="<?php echo $sem1["sem"]; ?>"><span><?php echo $menu_nama; ?></span></a>
</li>
...
<li <?php if($klik1==$sem1['week']){ echo "class='active '";} ?>>
<a href='<?php echo $site."/lessonplanner_control/planner_teacher/2/$sem1[week]/$uuid/$yr";?>' title="<?php echo $sem1["sem"]; ?>"><span style="color:#F00"><?php echo $menu_nama; ?></span></a>
</li>
...
<li <?php if($klik1==$sem1['week']){ echo "class='active '";} ?>>
<a href='<?php echo $site."/lessonplanner_control/planner_teacher/2/$sem1[week]/$uuid/$yr";?>' title="<?php echo $sem1["sem"]; ?>"><span><?php echo $menu_nama; ?></span></a>
</li>
