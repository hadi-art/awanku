...
echo "<br>";
		?>    &nbsp;&nbsp;&nbsp;<?php /*?><textarea name="toolkit_others" cols="22" rows="2" wrap="hard" ><?php echo $rw['toolkit_others'] ?></textarea><?php */?>
	...
	<br /><br />
		...
		?>
		<br />
    	&nbsp;&nbsp;&nbsp;<?php /*?><textarea name="emk_others" cols="22" rows="2" wrap="hard" placeholder="EMK Others" ><?php echo $rw['emk_others'] ?></textarea><?php */?>
