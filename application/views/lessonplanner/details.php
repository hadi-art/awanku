...
<table border="1" style="height:auto; border-collapse:collapse;" cellspacing="5">
	...
	<tr>
		...
		<td><b>Time	: </b><input type="time" name="Ftime" value="<?php echo $rw['Ftime'];?>" readonly="readonly"> To <br /> <input type="time" name="Ttime" value="<?php echo $rw['Ttime'];?>" readonly="readonly"></td>
	...
	<tr>
		...
		<td colspan="2"><b><br />Key &amp; Related Concepts :</b><br />
		<label name="concept" cols="50" rows="4" wrap="hard" ><?php echo nl2br($rw['concept']) ?></label></td>
		<td rowspan="8" valign="top"><br /><br /><p><b>21st Century Learning Skill
		<br>
...
echo "<br>";
		...
		<br /> &nbsp;&nbsp;&nbsp;<?php /*?><textarea name="toolkit_others" cols="22" rows="2" wrap="hard" placeholder="Others" ><?php echo $rw['toolkit_others'] ?></textarea><?php */?>
