...
{ echo "class='active '";} ?>>
<a href='<?php echo $site."/lessonplanner_control/my_planner/1/$sem/$subject/$y";?>' title="<?php echo $data["year"]; ?>"><span><?php echo $y; ?></span></a>
</li>
...
<a href='<?php echo $site."/lessonplanner_control/my_planner/1/$sem1[week]/$subject/$yr";?>' title="<?php echo $sem1["sem"]; ?>"><span><?php echo $menu_nama; ?></span></a>
</li>
...
<li <?php if($klik1==$sem1['week']){ echo "class='active '";} ?>>
<a href='<?php echo $site."/lessonplanner_control/my_planner/2/$sem1[week]/$subject/$yr";?>' title="<?php echo $sem1["sem"]; ?>"><span><?php echo $menu_nama; ?></span></a>
</li>
