...
<b><?php echo $fullname; ?></b><br /><a href="<?php echo "$site/lessonplanner_control/planner_teacherPDF/$sem/$week/$uuid/$year"; ?>"><img src ="<?php echo $base; ?>/images/printer-2.png" width = "25" height = "25"/></a> 
