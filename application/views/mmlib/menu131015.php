...
<input type="checkbox" id="css3menu-switcher" class="switchbox"><label onclick="" class="switch" for="css3menu-switcher"></label>	
	<li class="topfirst"><a href="<?php echo $site."/mmlib_control";?>" style="height:32px;line-height:32px;"><img src="<?php echo $base; ?>images/mmlib.png" width="32" height="32" alt=""/>Mmlib</a></li>
	...
	?>
	<li><a href="<?php echo $site."/mmlib_control/contentlist/$data[id]/0/2"?>"><?php echo $data["subject"]; ?></a>
	...
	<!--ibprofile=0 adalah semua ib-->
			...
			?>
			<li><a href="<?php echo $site."/mmlib_control/contentlist?subj=$data[id]&ibprofile=$dataib[id]&page=0&tahap=2"?>"><?php echo $dataib["profile"]; ?></a></li>
			<?php
			}//while
			?>
			</ul><?php */?>
	...
	while($data=mysql_fetch_array($r)){
	?>
	<li><a href="<?php echo $site."/mmlib_control/contentlist/$data[id]/0/1"?>"><?php echo $data["subject"]; ?></a>
	<!--tahap =1 adalah pmr-->
	<!--ibprofile=0 adalah semua ib-->
	<!-----sub sub menu----------------------------------------------------------------------------->
			<?php /*?><ul>
			...
			while($dataib=mysql_fetch_array($r2)){
			?>
			<li><a href="<?php echo $site."/mmlib_control/contentlist?subj=$data[id]&ibprofile=$dataib[id]&page=0&tahap=1"?>"><?php echo $dataib["profile"]; ?></a></li>
			<?php
			}//while
			?>
			</ul><?php */?>
...
<!------------------------------------------------end menu bar-----------------------------------------------------------------	-->	</td>
	...
	<td>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo $site."/mmlib_control"; ?>"><img src="<?php echo $base; ?>images/mmlib.png" alt="K tube" width="100" height="60"/></a></td>
  </tr>
  <?php /*?><tr>
    <td>&nbsp;</td>
