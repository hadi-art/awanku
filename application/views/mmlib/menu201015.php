...
<ul>
		...
		<li><a href="<?php echo $site."/awanku_control/"?>" style="height:34px;line-height:34px;width:93px;text-align:center;cursor:pointer;"><img src="<?php echo $base."include/menubar/"; ?>menubar_files/css3menu1/home.png"  width="40px" alt=""/></a> 
	
    <li class="has-sub"><a style="height:34px;line-height:34px;width:150px;text-align:center; width:93px;cursor:pointer;"><img src="<?php echo $base."include/menubar/"; ?>menubar_files/css3menu1/kipas.png" width="65px" alt=""/> </a>
      <ul>
        <li><a href="<?php echo $site."/awanku_control/category1"?>"  style="text-align:left; width:93px;">High Impact Education</a></li>
        <li><a href="<?php echo $site."/awanku_control/category2"?>"style="text-align:left; width:93px;">Integrated Services Facilities</a></li>
        <li><a href="<?php echo $site."/awanku_control/category3"?>"  style="text-align:left; width:93px;">Well Informed Society</a></li>
      </ul>
    </li>
	
		
    <li><a onClick="goBack()" style="height:34px;line-height:34px; text-align:center; width:70px;cursor:pointer;"><img src="<?php echo $base."include/menubar/"; ?>menubar_files/css3menu1/256base-redo.png" width="35px" height="35px"  alt="Undo"/>&nbsp 
      </a></li>
	
	<li><a onClick="goForward()" style="height:34px;line-height:34px; text-align:center; width:70px;cursor:pointer;"><img src="<?php echo $base."include/menubar/"; ?>menubar_files/css3menu1/256base-rundo.png" width="35px" height="35px" alt="Redo"/>&nbsp 
      </a></li>
	
    
         <li class='has-sub'><a href='#' style="height:34px;line-height:34px; text-align:center; width:70px;cursor:pointer;"><span>SPM</span></a>
            <ul>
	...
	?>
	<li><a href="<?php echo $site."/mmlib_control/contentlist/$data[id]/0/2"?>" style="text-align:left; width:70px;"><?php echo $data["subject"]; ?></a>
	...
	?>
         ...
         <li class='active has-sub'><a href='#' style="height:34px;line-height:34px; text-align:center; width:70px;cursor:pointer;"><span>PT3</span></a>
         <ul>
	<?php
	...
	while($data=mysql_fetch_array($r)){
	?>
	<li><a href="<?php echo $site."/mmlib_control/contentlist/$data[id]/0/1"?>" style="text-align:left; width:70px;"><?php echo $data["subject"]; ?></a>
	<!--tahap =1 adalah pmr-->
	<!--ibprofile=0 adalah semua ib-->
	<!-----sub sub menu----------------------------------------------------------------------------->
			<?php /*?><ul>
	...
	?>
		...
		<li class="has-sub"><a style="height:34px;line-height:34px; text-align:center; width:110px;cursor:pointer;"><img src="<?php echo $base."include/menubar/"; ?>menubar_files/css3menu1/service.png" width="32px" height="32px"  alt=""/><?php echo $_SESSION["log"]["fullname"]; ?></a>
		<ul>
	...
	<li><a href="<?php echo $site."/mmlib_control";?>" style="height:34px;line-height:34px; text-align:center; width:80px;cursor:pointer;"><img src="<?php echo $base; ?>images/mmlib.png" width="40px"alt=""/></a></li>
</ul>
</div>
