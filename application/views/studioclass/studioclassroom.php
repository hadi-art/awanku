  ...
  <table border="1" cellpadding="2" cellspacing="0" id="tablektube">
    <thead>
      <tr> 
        ...
        <th style="padding: 5px;">Class Student</th>
...
while($classroom=mysql_fetch_array($r)){
		$q="SELECT COUNT(*) FROM tbl_userinfo WHERE class_id='$classroom[id]'";
		list($kira)=mysql_fetch_row(mysql_query($q));

?>
    <tr> 
      <td style="padding: 5px; text-align:center"><?php echo $bil+1; ?></td>
      <td style="padding: 5px; text-align:center"><?php echo $classroom["name"]; ?></td>
      <td style="padding: 5px;"><?php echo getnama("fullname","tbl_userinfo","id",$classroom["guru_id"]); ?></td>
      <td style="padding: 5px; text-align:center"><?php echo $kira." Student";?></td>
...
if($edit==1){
*/
$guru=$_SESSION["log"]["fullname"];
if(getnama("fullname","tbl_userinfo","id",$classroom["guru_id"])==$guru){
?>

<a href="<?php echo $site;?>/studioclass_control/class_edit?id=<?php echo $classroom["id"]; ?>&level=<?php echo $classroom["level"];?>" title="Edit Title"><img src ="<?php echo $base; ?>/images/edit2.png" width = "25" height = "25"/></a>
