...
?>
    <tr> 
      ...
      <td style="padding: 5px;"> <a href="<?php echo base_url('index.php/studioclass_control/camclass/?cid='.$classroom["id"].''); ?>" title="<?php echo $classroom["name"]; ?>" rel="gb_page_center[1100, 600]" target="_blank"><img src ="<?php echo $base; ?>/images/view.png" width = "30" height = "30"/></a> 
        <?php /*?>
