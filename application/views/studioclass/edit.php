...
if(isset($_GET['delete']))
{
	...
	$q="UPDATE tbl_userinfo SET class_id='' WHERE id='$id'";
	mysql_query($q);
	
	$d="UPDATE classlist_set SET class_id='', language_id='', bio_id='', chem_id='', fiz_id='', english_id='', addmath_id='', math_id='', kem_id='' WHERE stud_id='$id'";
	mysql_query($d);
...
if(isset($_POST['edit']))
{
	...
	$q="UPDATE tbl_userinfo SET class_id='' WHERE class_id='$_GET[id]'";	
	mysql_query($q);
	
	$q="UPDATE classlist_set SET class_id='', language_id='', bio_id='', chem_id='', fiz_id='', english_id='', addmath_id='', math_id='', kem_id='' WHERE class_id='$_GET[id]'";	
	mysql_query($q);
...
?>
    <tr> 
      ...
      <td align="center"> <a onClick="return confirm('Confirm to delete <?php echo $classroom["fullname"]; ?> ?')"  href="<?php echo $site;?>/studioclass_control/edit?id=<?php echo $classroom["class_id"]; ?>&delete=<?php echo $classroom["id"]; ?>"><img src ="<?php echo $base; ?>/images/delete.png" width = "30" height = "30"/></a></td>
