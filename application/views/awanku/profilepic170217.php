...
$q="update tbl_userinfo set password='$_POST[password]', class_id='$_POST[class]', email='$_POST[email]', nohp='$_POST[notel]', notel='$_POST[tel]' Where username='$nama'";
...
?>
	...
	<td width="6">:</td>
	<td width="287"><?php echo $row["fullname"]; ?>&nbsp;&nbsp;<b><a  href="<?php echo $base;?>index.php/my_attandance" onclick="window.open(this.href, 'child', 'scrollbars,width=650,height=600'); return false" style="color:#009">My Attandance</a></b></td>
    </tr>
...
?>
    ...
    <td width="110">Fullname</td>
	<td width="6">:</td>
	<td width="287"><?php echo $row["fullname"]; ?></td>
    </tr>
