...
?>
    <div align="center"> 
      <table border="0">
        <tr> 
          ...
          <td> <span class="style1">| INTERGRATED SERVICES FACILITIES |</span></td>
          <td> </td>
        </tr>
      </table>
    </div>
    <table>
      ...
      <tr> 
        <td><a href="<?php echo base_url('index.php/report_control'); ?>"><?php echo img($image4); ?></a></td>
        <td><?php echo img($image6); ?></td>
