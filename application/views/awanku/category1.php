...
<td>
 <?php 
  if ($r=="1")
	 ...
	 ?>
        <a href="<?php echo "$site/lessonplanner_control/lessonPlannerTeacher/1/1/$year"; ?>"><?php echo img($image5); ?></a>
...
<tr>
  ...
  <td><?php /*?>
  <a href="<?php echo "$site/lessonplan_control/?cid"; ?>"><?php echo img($image4); ?></a><?php */?> </td>
...
<?php
  ...
  <table>
<tr>
  <td><a href="<?php echo "$site/ktube_control"; ?>"><?php echo img($image2); ?></a></td>
