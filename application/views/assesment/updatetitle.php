...
if (isset($_POST["edit"]))
{
		...
		$update = "update elearning_title set title='$question',level='$level', subject='$subject' where title_id='$title_id'";
...
<?php
	...
	$query="Select * from elearning_title where title_id='$title_id'";
	$result=mysql_query($query);
	$row=mysql_fetch_array($result);
	{
	?>
	<center><h3>Edit Level and Subject</h3></center>
	<form method="post">
	<table align="center">
	<tr>
			<td>Title </td>
			<td>:</td>
 			<td><textarea name="soalan" style="width:400px;height:50px;" required><?php echo $row["title"]; ?></textarea></td>
    </tr>
	<tr>
    			<td>Level</td>
				<td> :</td>
