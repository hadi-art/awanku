...
if(isset($_POST['submit']))
{
		...
		if($lastid == 0)
		{
		   ...
		   $insert=mysql_query("insert into elearning_title set title='$title', level='$level', datetimestamp='$datex', form='$form', 
		   subject='$subjek', upload_by='$upload_by'")or die(mysql_error());
