...
$query="SELECT * FROM elearning_title WHERE form='$subject' and flag=1";
	$q=mysql_query($query);
	
?>
 	<h3><center><?php echo $subject; ?> QUESTION LIST</center></h3>
...
<form method="post" action="<?php echo base_url('index.php/assesment_control/search')?>">
	<tr>
<?php /*?>		<td align="center"><input type="text" width="100%" class="search" id="searchid" name="search" placeholder="Search for title" />
