...
if(isset($_GET['delete']))
{
	...
	$q1="UPDATE classlist_set set chem_id='' where id='$id'";
	mysql_query($q1);
	}
	
			if ($subj == "19"){

	$q1="UPDATE classlist_set set fiz_id='' where id='$id'";
	mysql_query($q1);
	}

		if ($subj == "6"){

	$q1="UPDATE classlist_set set bio_id='' where id='$id'";
	mysql_query($q1);
	}
...
if(isset($_POST['edit']))
{
	...
	$q1="UPDATE classlist_set set chem_id='' where class_level='$_GET[form]'";
	mysql_query($q1);
	}
	
			if ($subj == "6"){

	$q1="UPDATE classlist_set set bio_id='' where class_level='$_GET[form]'";
	mysql_query($q1);
	}

		if ($subj == "19"){

	$q1="UPDATE classlist_set set fiz_id='' where class_level='$_GET[form]'";
	mysql_query($q1);
	}
...
$q="SELECT * FROM classlist_set WHERE class_level='$form' AND fiz_id = '$g'";
$r=mysql_query($q);
...
<td align="center"> <a onClick="return confirm('Confirm to delete <?php echo $classroom["fullname"]; ?> ?')"  href="<?php echo $site;?>/report_control/senaraipelajar?delete=<?php echo $classroom["id"]; ?>&subject=<?php echo $_GET['subject'];?>&form=<?php echo $_GET['form'];?>"><img src ="<?php echo $base; ?>/images/delete.png" width = "30" height = "30"/></a></td>
...
$q="SELECT * FROM classlist_set WHERE class_level='$form' AND chem_id = '$g'";
$r=mysql_query($q);
while($classroom=mysql_fetch_array($r)){
?>
    <tr> 
...
$q="SELECT * FROM classlist_set WHERE class_level='$form' AND bio_id = '$g'";
$r=mysql_query($q);
while($classroom=mysql_fetch_array($r)){
?>
    <tr> 
