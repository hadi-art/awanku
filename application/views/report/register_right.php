  ...
  if(isset($_POST['submit']))
{
	...
	$insert=mysql_query("insert into tbl_userinfo set fullname='$fullname', noic='$noic', email='$email', username='$nama' , notel='$tel' , nohp='$notel' , password='$password',class_id='',class_level='', level_id='$level' ")or die(mysql_error());
...
<br /><br />
<div id="tablektube">
<h2><br /><div align="center" style="color:#000; background:#59E0DA; width:90%; height:30px;"><strong>Register New User</strong></div></h2>
...
<table width="510" border="0" align="center">
   ...
   <?php /*?> <tr>
    ...
    <tr>
    	<td colspan="3"><center> <input name="submit" type="submit" value="Submit" > </center></td>
