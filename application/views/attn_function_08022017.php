...
//------------------------------------------- STAFF 1 -------------------------------------------------------
	...
	{	
		...
		{		
				 if (new DateTime($timesahaja) > new DateTime("07:30:00"))
				{				
...
//--------------------------------------------- STAFF 2 ---------------------------------------------------------
	...
	{	
		...
		{		
				if (new DateTime($timesahaja) > new DateTime("08:00:00"))
				{				
					$paparan="<font color='red'>$timesahaja</font>";				
				}//if lebih dr kul 730
...
function guru1_getin($iduser,$hari,$bulantahun)
	{	
		...
		{		
				if (new DateTime($timesahaja) > new DateTime("07:20:00"))
				{				
					$paparan="<font color='red'>$timesahaja</font>";				
				}//if lebih dr kul 730
...
//---------------------------------------------END GURU 3 ------------------------------------------------------
	...
	function status_harianstaff1($userid){
		...
		if($masadatang==""){
			...
			//$var="";
			if (new DateTime($masadatang) > new DateTime("07:30:00")){
	...
	function status_harianstaff2($userid){
		...
		if($masadatang==""){
			...
			//$var="";
			if (new DateTime($masadatang) > new DateTime("08:00:00")){
				$var="class='active_lambatdatang '";				
				}//if (new DateTime($masadatang) < new DateTime("08:30:00"))
			else{
		...
		if($masadatang==""){
			...
			//$var="";
			if (new DateTime($masadatang) > new DateTime("07:20:00")){
				$var="class='active_lambatdatang '";				
				}//if (new DateTime($masadatang) < new DateTime("08:30:00"))
			else{
		...
		if($masadatang==""){
			...
			//$var="";
			if (new DateTime($masadatang) > new DateTime("07:00:00")){
				$var="class='active_lambatdatang '";				
				}//if (new DateTime($masadatang) < new DateTime("08:30:00"))
			else{
...
//-------------------------------------------  kontraktor -------------------------------------------------------
	...
	{	
		...
		{		
				 if (new DateTime($timesahaja) > new DateTime("07:00:00"))
				{				
					$paparan="<font color='red'>$timesahaja</font>";				
				}//if lebih dr kul 730
...
//-------------------------------------------  TTT -------------------------------------------------------
	...
	function TTT_getin($iduser,$hari,$bulantahun)
	{	
		$hari=sprintf('%02d', $hari);	
		$datefull=$bulantahun."-".$hari;
	...
	function TTT_getout($iduser,$hari,$bulantahun)
	{
