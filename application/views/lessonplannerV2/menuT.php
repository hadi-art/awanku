...
{ echo "class='active '";} ?>>
<a href='<?php echo $site."/lessonplanner_control/lessonPlannerTeacher/1/$sem/$y";?>' title="<?php echo $data["year"]; ?>"><span><?php echo $y; ?></span></a>
</li>
...
<a href='<?php echo $site."/lessonplanner_control/lessonPlannerTeacher/1/$sem1[week]/$yr";?>' title="<?php echo $sem1["sem"]; ?>"><span><?php echo $menu_nama; ?></span></a>
</li>
...
<li <?php if($klik1==$sem1['week']){ echo "class='active '";} ?>>
<a href='<?php echo $site."/lessonplanner_control/lessonPlannerTeacher/2/$sem1[week]/$yr";?>' title="<?php echo $sem1["sem"]; ?>"><span><?php echo $menu_nama; ?></span></a>
</li>
