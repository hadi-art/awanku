...
<?php */?>	
    <li class="has-sub"><a href="<?php echo $site."/awanku_control/"?>" style="height:34px;line-height:34px;width:150px;text-align:center; width:100px;cursor:pointer;"><img src="<?php echo $base."include/menubar/"; ?>menubar_files/css3menu1/kipas.png" width="65px" alt=""/> </a>
     <ul>
<?php /*?>	<li><a href="<?php echo $site."/lessonplanner_control/lessonPlannerTeacher"?>"  style="text-align:left; width:100px;">Teacher</a></li>
<?php */?>        <li><a href="<?php echo $site."/lessonplanner_control/plannerlesson_subject"?>"  style="text-align:left; width:100px;">Subject</a></li>
         <?php /*?>
...
<div style="background:#3C6; width:75%; height:30px; color:#FFF"><h2><strong>
<!--yg bawah ni utk view semua spm atau semua pmr content-->
<a href="<?php echo "$site/lessonplanner_control/lessonPlannerTeacher/$sem/$week/$year"; ?>" style="color:#FFF"><?php echo "Week - ".$week." Year - ".$year;?></a>
</strong></h2></div> 
