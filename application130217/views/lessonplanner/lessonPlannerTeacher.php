...
<br><table width="80%" border="0" cellpadding="1" cellspacing="0">
    ...
    <tr>
        <td>
            ...
            <div>
            <?php 
			$q="select * from tbl_userinfo where flag='1' and level_id='1'  ORDER BY fullname ASC  limit 30";
            $r=mysql_query($q); 
     	...
     	<td>
            <table>
            <div>
            <?php $q="select * from tbl_userinfo where flag='1' and level_id='1'  ORDER BY fullname ASC  limit 30,30";
            $r=mysql_query($q); 
            ...
            <table>
            <div>
            <?php $q="select * from tbl_userinfo where flag='1' and level_id='1'  ORDER BY fullname ASC  limit 60,30";
            $r=mysql_query($q); 
        ...
        <td>
        	<table>
            <div>
            <?php $q="select * from tbl_userinfo where flag='1' and level_id='1'  ORDER BY fullname ASC  limit 90,30";
            $r=mysql_query($q); 
