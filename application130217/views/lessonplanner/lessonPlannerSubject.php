...
<?php  echo $uuid;
               ...
               $q="select approve_status,req_app_1,req_app_2,req_app_3 from ilearn_content where flag='1' AND approve_status = '3'";
					list($approve_status,$req_app_1,$req_app_2,$req_app_3)=mysql_fetch_row(mysql_query($q));

			if ($approve_status=="3" && ($req_app_1 == $uuid || $req_app_2 == $uuid || $req_app_3 == $uuid)  ) {
