...
$sql ="INSERT INTO ilearn_content set subject_id ='$subject_id', upload_id ='$upload_id', file_id='$idcontent', topic ='$topic', objective ='$objective', 
	activity ='$activity', outcome ='$outcome', class_id ='$_POST[class_id]', week ='$_POST[week]', sem ='$sem',year='$yearss', datePost ='$today',date ='$date',
...
if(isset($_POST['submit'])) 
{
	...
	{
		$sql ="INSERT INTO ilearn_content set subject_id ='$subject_id', upload_id ='$upload_id', file_id='$idcontent', topic ='$topic', objective ='$objective', 
	activity ='$activity', outcome ='$outcome', class_id ='$_POST[class_id]', week ='$_POST[week]', sem ='$sem',year='$yearss', datePost ='$today',date ='$_POST[date]',
	Ftime='$Ftime', Ttime='$Ttime', flag ='1', quiz_id='$idtitle', ibprofile_id='$id_ibprofile', toolkit_id='$id_toolkit',toolkit_leap_id='$id_toolkit_leap',global_context ='$global', concept ='$concept', inquiry ='$inquiry', approaches ='$approaches', existing_knowledge ='$existing', source ='$source', description1 ='$desc1',description2 ='$desc2', description3 ='$desc3', remarks='$remark', req_app_1='$req1', req_app_2='$req2', req_app_3='$req3', approve_by='$approve_by',approve_status='3'";
...
<input name="tahun" type="hidden" value="<?php print $yearss  ?>">
...

{
		...
		$q="SELECT * FROM classlist_v2 WHERE flag ='1' GROUP BY level";
		$name=mysql_query($q);
