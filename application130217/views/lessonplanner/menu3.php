...
<div id="cssmenu">
<ul>
<?php /*?>	<li><a href="<?php echo $site."/awanku_control/"?>" style="height:34px;line-height:34px;width:100px;text-align:center;cursor:pointer;"><img src="<?php echo $base."include/menubar/"; ?>menubar_files/css3menu1/home.png"  width="40px" alt=""/></a> 
<?php */?>	
...
<?php */?>    </li>
    ...
    <li class='has-sub'><a style="height:34px;line-height:34px; text-align:center; width:250px;cursor:pointer;"><img src="<?php echo $base."include/menubar/"; ?>menubar_files/css3menu1/service.png" width="35px" height="35px" alt=""/> <?php echo $_SESSION["log"]["fullname"]; ?></a> 
      <ul>
        <li>
        <?php
			if($uid=='715' || $uid=='7' || $uid=='26' || $uid=='39' || $uid=='23' || $uid=='25' || $uid=='76'){
		?>
        <a href="<?php echo $site."/lessonplanner_control/approvelessonplanner"?>"  style="text-align:left; width:250px;">Approve Lesson Planner</a>
        <?php } ?>
