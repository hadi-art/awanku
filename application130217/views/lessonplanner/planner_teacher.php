...
<div align="right"><a onClick="return confirm('Confirm to Approve')"  href="?approve&id=<?php echo $row["id"]; ?>" title="Approve lesson plan"><input name="submit" type="submit" alt="submit" value="CHECK ALL"></a></div>
