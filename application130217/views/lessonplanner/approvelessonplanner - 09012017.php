	...
	<thead>
		<tr>
		  <th width="37"><center>Date </center></th>
			...
			<th width="118"><center>Learning Area(s)</center></th>
			<th width="131"><center>Learning Activities</center></th>
            <th width="131"><center>Remarks</center></th>
...
?>
		<tr style="background:#FFFFFF"> 	  	
			...
			<td><textarea name="remark" cols="20" rows="4" wrap="hard" ></textarea></td>
			<td>
		...
		<td>
        		<input name="id" type="hidden" value="<?php echo $row["id"]; ?>">
         		<input name="submit" type="image" alt="submit" value="Submit" src="<?php echo $base; ?>/images/yes.jpeg" width = "40" height = "40">
