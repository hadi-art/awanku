...
<?php */?>	
 ...
 <?php */?>     </ul>
	...
	<li><a href="<?php echo $site."/lessonplan_control/plannerlesson_subject";?>" style="height:34px;line-height:34px; text-align:center; width:137px;cursor:pointer;"><img src="<?php echo $base; ?>images/lessonplanner.png"width="34px" height="34px" alt=""/></a></li>
...
{ echo "class='active '";} ?>>
<a href='<?php echo $site."/lessonplan_control/teacher_plan/1/$sem/$subject/$class/$y";?>' title="<?php echo $data["year"]; ?>"><span><?php echo $y; ?></span></a>
</li>
...
<a href='<?php echo $site."/lessonplan_control/teacher_plan/1/$sem1[week]/$subject/$class/$yr";?>' title="<?php echo $sem1["sem"]; ?>"><span><?php echo $menu_nama; ?></span></a>
</li>
...
<li <?php if($klik1==$sem1['week']){ echo "class='active '";} ?>>
<a href='<?php echo $site."/lessonplan_control/teacher_plan/2/$sem1[week]/$subject/$class/$yr";?>' title="<?php echo $sem1["sem"]; ?>"><span><?php echo $menu_nama; ?></span></a>
</li>
