...
return $path;
	...
	if ($subject == "12" || $subject == "14" || $subject == "16" || $subject == "18")
		{
				$q="SELECT level FROM classlist_v2 where id=$class";
				list($name)=mysql_fetch_row(mysql_query($q));
				
					$query="Select * from ilearn_content where sem='$sem' AND week='$week' AND subject_id= '$subject' AND class_id='$name' AND year='$year' AND flag= '1' and approve_status='1'";
	$result=mysql_query($query);
			...
			$query="Select * from ilearn_content where sem='$sem' AND week='$week' AND subject_id= '$subject' AND class_id='$class' AND year='$year' AND flag= '1' and approve_status='1'";
	$result=mysql_query($query);
