...
for($b=0;$b<count($_POST["student"]);$b++)
{
	...
	$q1="UPDATE classlist_set set chem_id='$g' where id='$studentid' and class_level='$_GET[form]'";
	mysql_query($q1);
	}
	
	if ($subj == "6"){

	$q1="UPDATE classlist_set set bio_id='$g' where id='$studentid' and class_level='$_GET[form]'";
	mysql_query($q1);
	}
	
	if ($subj == "19"){

	$q1="UPDATE classlist_set set fiz_id='$g' where id='$studentid' and class_level='$_GET[form]'";
	mysql_query($q1);
	}
...
$q="SELECT * FROM classlist_set WHERE class_level='$form' AND chem_id = '' ORDER BY fullname ASC";
...
$q="SELECT * FROM classlist_set WHERE class_level='$form' AND fiz_id = '' ORDER BY fullname ASC";
...
$q="SELECT * FROM classlist_set WHERE class_level='$form' AND bio_id = '' ORDER BY fullname ASC";
