...
<div id="maindiv" align="center" style="width:100%; background-color:#FFFFFF; height: auto; margin-top:1%">

<div id="category" style="float:left; margin-top:2%; margin-left:1%; width:1%" >

	<?php	while ($row = mysql_fetch_array($title)) {
...
<nav>
    ...
    <div class="menu-item">
      <h4><a href="#"><?php echo $row["sub_name"];?></a></h4>
      <ul><?php while ($b = mysql_fetch_array($name)) {  ?>
          
          <li style="text-align:left">
          <a href="?form=<?php echo $b["form"];?>&subject=<?php echo $b["subject_id"];?>&group=<?php echo $b["set_id"];?>">FORM <?php echo $b["form"]; echo ' - '; echo $b["group_set"];?></a></li><?php } ?>
      </ul>
    </div>
...
$q="SELECT * FROM ktube_subject WHERE subject_id='$sub'";
$r=mysql_query($q);
...
?>
<center><b> 
<?php echo $subject_name; ?> From <?php echo $_GET["form"]; ?> - <?php echo $set; }?> </b></center>
...
<div id="cctv" style="float:right; width:80%; height:auto; background-color:#FFFFCC; margin-top:5%; margin-right:2%">
	...
	<iframe src="student_list?form=<?php echo $_GET['form'];?>&subject=<?php echo $_GET['subject'];?>" width="100%" height="700px" frameborder="0" scrolling="auto"></iframe>
    
		</div> 
		<div class="bottominforight" style="float:right;padding: 5px; border-width: 1px;  border-color: #000000; width:47%;">
		
       	  <iframe src="senaraipelajar?form=<?php echo $_GET['form'];?>&subject=<?php echo $_GET['subject'];?>" width="100%" height="700px" frameborder="0" scrolling="auto"></iframe>
		</div>
	</div>
<?php }?>
