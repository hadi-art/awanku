...
//---------------------------------- class_set insert ---------------------------------------------------------------------------------------
	...
	//$insert=mysql_query("insert into classlist_set set stud_id='$id', fullname='$fullname', class_id='$class',class_level='$form'")or die(mysql_error());
	
	$rn = "SELECT * FROM class_set";
	$r=mysql_query($rn);
			...
			if ($sub_id == "10"){
				if($class == $clas){ 				
				echo "UPDATE classlist_set set english_id='$set' where stud_id='$id'";	
				//mysql_query($sub1);	
				}	else {
					echo "error";	
					//mysql_query($sub1);	 
...
<table width="510" border="0" align="center">
	...
	<tr>
			...
			<td width="8">:</td>
	  <td width="336"><input name="fullname" type="text" size="30"></td>
    </tr>
	...
	<tr>
	  		<td>IC</td>
	  		<td>:</td>
	  		<td><input name="noic" type="text" size="30" maxlength="12"  placeholder="Contoh : 860424035123">
			</td>
   </tr>
