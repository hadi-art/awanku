...
<?php */?>	
	...
	<li><a href="<?php echo "$site/dailyreport_control"; ?>" style="height:34px;line-height:34px; text-align:center; width:137px;cursor:pointer;"><img src="<?php echo $base; ?>images/2d_timemgt.jpg"width="34px" height="34px" alt=""/></a></li>
