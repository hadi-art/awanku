...
if(isset($_POST['submit'])) 
{
	...
	$sql ="INSERT INTO daily_report set teacher_id ='$_POST[teacher_id]', day ='$_POST[day]', date='$new_date', assembly ='$assembly', disiplin ='$disiplin', activities='$activities', emergency='$emergency', damage='$damage', etc='$etc', datetimestamp='$datex', respon_a='$r_a', respon_d='$r_d', respon_ac='$r_ac', respon_e='$r_e', respon_da='$r_da', respon_etc='$r_etc'";
