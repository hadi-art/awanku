...
<ul>
		...
		<li><a href="<?php echo $site."/awanku_control/"?>" style="height:34px;line-height:34px;width:40px;text-align:center;cursor:pointer;"><img src="<?php echo $base."include/menubar/"; ?>menubar_files/css3menu1/home.png"  width="40px" alt=""/></a> 
	
    <li class="has-sub"><a style="height:34px;line-height:34px;width:150px;text-align:center; width:60px;cursor:pointer;"><img src="<?php echo $base."include/menubar/"; ?>menubar_files/css3menu1/kipas.png" width="65px" alt=""/> </a>
      <ul>
        <li><a href="<?php echo $site."/awanku_control/category1"?>"  style="text-align:left; width:100px;">High Impact Education</a></li>
       <?php /*?> <li><a href="<?php echo $site."/awanku_control/category2"?>"style="text-align:left; width:100px;">Integrated Services Facilities</a></li>
        <li><a href="<?php echo $site."/awanku_control/category3"?>"  style="text-align:left; width:100px;">Well Informed Society</a></li><?php */?>
      </ul>
    </li>
...
<li><a onClick="goBack()" style="height:34px;line-height:34px; text-align:center; width:25px;cursor:pointer;"><img src="<?php echo $base."include/menubar/"; ?>menubar_files/css3menu1/256base-redo.png" width="35px" height="35px"  alt="Undo"/>&nbsp 
    ...
    <li class='has-sub'><a href='#' style="height:34px;line-height:34px; text-align:center; width:25px;cursor:pointer;"><span>SPM</span></a> 
      <ul>
	...
	?>
        <li><a href="<?php echo $site."/ktube_control/contentlist/$data[id]/0/2"?>" style="text-align:left; width:100px;"><?php echo $data["subject"]; ?></a> 
          <!--tahap =2 adalah spm-->
    ...
    <li class='has-sub'><a href='#' style="height:34px;line-height:34px; text-align:center; width:25px;cursor:pointer;"><span>PT3</span></a> 
      <ul>
        <?php
	...
	while($data=mysql_fetch_array($r)){
	?>
        <li><a href="<?php echo $site."/ktube_control/contentlist/$data[id]/0/1"?>" style="text-align:left; width:100px"><?php echo $data["subject"]; ?></a> 
          <!--tahap =1 adalah pmr-->
          <!--ibprofile=0 adalah semua ib-->
          <!-----sub sub menu----------------------------------------------------------------------------->
          <?php /*?>
	...
	?>
	 ...
	 <?php /*?><li><a href="<?php echo $site."/ktube_control/steam/22/0/3"?>" style="height:34px;line-height:34px; text-align:center; width:25px;cursor:pointer;">STEAM</a></li><?php */?>
