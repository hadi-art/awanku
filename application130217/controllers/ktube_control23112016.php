...
class Ktube_control extends CI_Controller {
	...
	//die();
		...
		if($selection == 'Video'){
				...
				elseif($levelcek == "STEAM")
				{
					 $level_id = 3;
				}
				
				elseif($levelcek == "DIPLOMA")
				{
					 $level_id = 4;
				}
					...
					if (!$this->upload->do_upload('file')) 
					{
						...
						$q="insert into ktube_content set title='$title', subj_id='$_POST[subjek]',profile_id='$_POST[idp]', level='$_POST[level]', level_id='$level_id', type2='$_POST[type2]', upload_by='$_POST[upload_by]',  name='$nameasal', path='$target_pathdb', type='$type',  size ='$size', flag='1',time='$datex', thumbnail_img = '$imageFile',source_id='$_POST[source]', server_id='1'";
				mysql_query($q); 
           ...
           // unset($config);
				...
				elseif($levelcek == "DIPLOMA")
				{
					...
					if (!$this->upload->do_upload('file')) 
					{
						...
						$q="insert into ktube_content set title='$title', subj_id='$_POST[subjek]',profile_id='$_POST[idp]', level='$_POST[level]', level_id='$level_id', type2='$_POST[type2]', upload_by='$_POST[upload_by]',  name='$name', path='$target_pathdb', type='$ftype',  size ='$size', flag='1', time='$datex',source_id='$_POST[source]',server_id='1'";
				mysql_query($q);
