...
$q="SELECT a.*,b.ip as server_path FROM ktube_content a,ktube_server b WHERE a.flag=1 and a.server_id=b.id $cond_subj $cond_tahap limit $startpage,$bilperpage";
$r=mysql_query($q);
$bil=$startpage;
