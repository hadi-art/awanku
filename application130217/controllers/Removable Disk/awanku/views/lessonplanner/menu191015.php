...
<li class="has-sub"><a style="height:24px;line-height:24px;">Awanku</a>
	...
	<li><a href="<?php echo $site."/lessonplanner_control/plannerlesson_subject";?>" style="height:24px;line-height:24px;"><img src="<?php echo $base; ?>images/lessonplanner.png"width="34px" height="34px" alt=""/></a></li>
