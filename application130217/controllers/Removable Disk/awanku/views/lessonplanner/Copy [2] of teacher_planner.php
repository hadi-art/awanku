...
?>
		...
		{
		?>
		<li><a href="<?php echo base_url('index.php/lessonplanner_control/viewquestion/?cid='.$qz[$i].''); ?>"  rel="gb_page_center[900, 600]" target="_blank"><?php echo getquiz($qz[$i]);?></a></li>
		<br>	
		<?php
		}
		?>
...
<a href="<?php echo base_url('index.php/lessonplanner_control/teacher_view/?cid='.$row["class_id"].''); ?>" title="<?php echo $row["class_id"]; ?>" rel="gb_page_center[900, 600]" target="_blank"><img src ="<?php echo $base; ?>/images/view.png" width = "30" height = "30"/></a>
<?php
}
?> </td>
