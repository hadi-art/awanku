...
$update="UPDATE ilearn_content SET date='$_POST[date]',Ftime='$_POST[Ftime]',Ttime='$_POST[Ttime]',class_id='$_POST[class_id]',week='$_POST[week]',sem='$_POST[sem]',global_context='$_POST[global]',concept='$_POST[concept]',inquiry='$_POST[inquiry]',approaches='$_POST[approaches]',topic='$_POST[topic]',outcome='$_POST[outcome]',objective='$_POST[objective]',existing_knowledge='$_POST[existing]',activity='$_POST[activity]',source='$_POST[source]',
description1='$_POST[desc1]',description2='$_POST[desc2]',description3='$_POST[desc3]',remarks='$_POST[remark]',file_id='$idcontent',quiz_id='$idtitle',ibprofile_id='$id_ibprofile',toolkit_id='$id_toolkit',toolkit_leap_id='$id_toolkit_leap' WHERE id='$_POST[id]'";
mysql_query($update);
...
<table border="1" style="height:auto; border-collapse:collapse;" cellspacing="5">
	...
	<tr>
		...
		<textarea name="global" cols="50" rows="4" wrap="hard" ><?php echo $rw['global_context'] ?></textarea></td>
		<td colspan="2">Key &amp; Related Concepts<br>
		<textarea name="concept" cols="50" rows="4" wrap="hard" ><?php echo $rw['concept'] ?></textarea></td>
	...
	<tr>
		...
		<td colspan="3"> 
		<textarea name="topic" cols="80" rows="4" wrap="hard" ><?php echo $rw['topic'] ?></textarea></td>
		
	</tr>
	
	<tr>
		<td>Learning Outcome(s)</td>
		<td colspan="3"><textarea name="outcome" cols="80" rows="4" wrap="hard" ><?php echo $rw['outcome'] ?></textarea></td>
	</tr>
	
	<tr>
		<td>Success Criteria</td>
		<td colspan="3"><textarea name="objective" cols="80" rows="5" wrap="hard" ><?php echo $rw['objective'] ?></textarea></td>
	...
	<tr>
		...
		<td colspan="3"> 
		<textarea name="existing" cols="80" rows="4" wrap="hard" ><?php echo $rw['existing_knowledge'] ?></textarea></td>
	...
	<tr>
		...
		<td colspan="3"> 
		<textarea name="activity" cols="80" rows="4" wrap="hard" ><?php echo $rw['activity'] ?></textarea></td>
	...
	<tr>
		...
		<td colspan="3"> 
		<textarea name="source" cols="80" rows="4" wrap="hard" ><?php echo $rw['source'] ?></textarea></td>	
	</tr>
	
	<tr>
		<td>Assessment / Reflection</td>
		<td>Who didn't meet the objective(s)?<br>
		<textarea name="desc1" cols="30" rows="3" wrap="hard" ><?php echo $rw['description1'] ?></textarea></td>
		<td>What would I change?<br>
		<textarea name="desc2" cols="30" rows="3" wrap="hard" ><?php echo $rw['description2'] ?></textarea></td>
		<td>How did I differentiate <br>
		<textarea name="desc3" cols="30" rows="3" wrap="hard" ><?php echo $rw['description3'] ?></textarea></td>
		<td>Notes:<br>
