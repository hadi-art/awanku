...
?>
	  <tr>
			...
			<td align="center"><?php echo getscore($row['id']); 
			...
			<td align="center"><?php 
				...
				else if(getprestasi($row['id']) >= 0)
				{
					...
					$totalquestion = gettotalquiz($id);
					
				
					
					$prestasi = getprestasi($row['id'])/ $totalquestion * 100;
					echo $prestasi;
					
					
					if ($prestasi >= 90 && $prestasi <=100)
					{
...
<?php
	...
	echo "Prestasi Keseluruhan : "; echo $newaverage*10; echo "%"; echo " ";

		if($newaverage >= 0 && ($avnewaverageg < 2.0))
		{
			echo "Sangat Lemah";
		}
		
		else if ($newaverage >= 2.1 && ($newaverage <4.0))
		{
			echo "Perlu Dibaiki";
		}
		
		else if($newaverage >= 4.1 && ($newaverage < 6.0))
		{
			echo "Memuaskan";
		}
		
		else if($newaverage >= 6.1 && ($newaverage < 8.0))
		{
			echo "Cemerlang";
		}
		
		else if($newaverage >= 8.1 && ($newaverage < 10.0))
		{
			echo "Sangat Cemerlang";
		}
