...
<tr>
  ...
  <td><?php echo getnama($data["upload_by"],"fullname","tbl_userinfo","id"); ?> <br /> [ <?php echo $data["time"]; ?> ]</td>
  <td><?php
...
<tr>
<td>
<a href="<?php echo $base."$data[path]";?>" title="<?php echo $data["title"]; ?>" rel="gb_page_center[600, 400]"><img src ="<?php echo $base; ?>/images/play.png" width = "30" height = "30"/></a>
</td>
