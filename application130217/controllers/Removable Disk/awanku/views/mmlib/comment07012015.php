...
//echo $path;
$pat=mysql_query("SELECT * FROM ktube_content WHERE id ='$cid' ");
...
<div style="background:#666; width:80%; height:30px; color:#FFF"><u><h2><strong>
...
<div id="video" style="width:56%; float:left; background-color:#FFFFFF">
<br />
...
<?php
		...
		<table style="font-size:small" width="75%" height="72">
		
		<tr> 

			<td width="24%">Video rating :</td>
					 <?php
		...
		?>
		 <td align="left" width="45%"><?php echo $data["view_count"]; ?> Views</td>
...
<div class="comment" style="width:43%; height:auto; background-color:#FFFFFF; height:auto">
<br />
<br />
...
<form action="" method="post">
	...
	<tr>
		<td width="174" height="26" align="right"><input type="text" name="search" id="search" required>
...
?>	
	<tr>
		<td>
	<a href="<?php echo base_url('index.php/mmlib_control/mmlib_video/0/0/0/?cid='.$runrows["id"].'')?>"><div style="color:#3366FF; text-decoration:underline"><?php echo $title ?></div></a>
		</td>
	</tr>
<?php
...
?>
			...
			<img src ="<?php echo $base."$data[thumbnail_img]"; ?>"/></a>
			
			</td>
			
			<td width="168"><a href="<?php echo base_url('index.php/mmlib_control/mmlib_video/0/0/0/?cid='.$data["id"].'')?>"><?php echo $data["title"]; ?></a>
