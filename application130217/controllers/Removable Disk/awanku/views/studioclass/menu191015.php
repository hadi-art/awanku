...
#tablektube thead tr th { 
  font-weight: bold;
  padding: 5px 4px;
  color:#000000;
  
}
#tablektube thead tr th span { 
  
  background-repeat: no-repeat;
  background-position: 100% 100%;
}

#tablektube thead tr th.headerSortUp, #keywords thead tr th.headerSortDown {
  background: #acc8dd;
}

#tablektube thead tr th.headerSortUp span {
  background-image: url('http://i.imgur.com/SP99ZPJ.png');
}
#tablektube thead tr th.headerSortDown span {
...
#tablektube tbody tr td {
  text-align: center;
  padding: 5px 13px;
}
#tablektube tbody tr td.lalign {
  text-align: left;
}

#tablektube table tr td a {
	display:block;
    height:100%;
    width:100%;
}
...
<ul>
	...
	<li><a href="<?php echo $site."/studioclass_control";?>" style="height:24px;line-height:24px;"><img src="<?php echo $base; ?>images/1studioclass.png" alt=""width="34px" height="34px"/></a></li>
</ul>
