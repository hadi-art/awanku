...
<div id="content" style="background:#FFFFFF;width:70%;margin-left:10px;height:auto; float:left;margin-top:10px; border-radius: 20px; ">
...
if($subject == 'PT3')
{ 
$query="SELECT * FROM elearning_title WHERE LEVEL='PT3' and flag=1";
	$q=mysql_query($query);
	
?>

	<br />
 	<h3><center>PT3 QUESTION LIST</center></h3>
...
if($subject == 'SPM')
{ 
$query="SELECT * FROM elearning_title WHERE LEVEL='SPM' and flag=1";
	$q=mysql_query($query);
	
?>

	<br />
 	<h3><center>SPM QUESTION LIST</center></h3>
	<table border ="0" width="92%" style="background-color:#FFFFFF; border-collapse:collapse; table-layout:fixed" align="center" >
    <tr style="background:#CCFFCC">
   		<th width="5%">Bil</th>
    ...
    <tr>
		...
		<td><center><?php echo getsubject($row['subject']); ?></center></td>
		...
		{
		?>
			<a href="<?php echo base_url('index.php/assesment_control/updatekuiz?cid='.$row["title_id"].'&level=SPM'); ?>"><img src ="<?php echo $base; ?>/images/edit2.png" width = "30" height = "30"/></a>
...
if($subject == 'STEAM')
{ 
$query="SELECT * FROM elearning_title WHERE LEVEL='STEAM' and flag=1";
	$q=mysql_query($query);
	
?>

	<br />
 	<h3><center>STEAM QUESTION LIST</center></h3>
	<table border ="0" width="89%" style="background-color:#FFFFFF; border-collapse:collapse; table-layout:fixed" align="center" >
    <tr style="background:#CCFFCC">
   		<th width="4%">Bil</th>
      	<th width="50%">Title</th>
    	<th width="16%">Subject</th>
    ...
    <tr>
		...
		{
		?>
			<a href="<?php echo base_url('index.php/assesment_control/updatekuiz?cid='.$row["title_id"].'&level=STEAM'); ?>"><img src ="<?php echo $base; ?>/images/edit2.png" width = "30" height = "30"/></a>
		...
		<a href="<?php echo base_url('index.php/assesment_control/viewquestion/?cid='.$row["title_id"].''); ?>" title="<?php echo $row["title"]; ?>" rel="gb_page_center[900, 550]" target="_blank"><img src ="<?php echo $base; ?>/images/view.png" width = "30" height = "30"/></a>		</td>
