  ...
  if(isset($_POST['submit']))
{
	...
	$insert=mysql_query("insert into tbl_userinfo set fullname='$fullname', noic='$noic', email='$email', username='$nama' , notel='$tel' , nohp='$notel' , password='$nama',class_id='',class_level='',picture='$file_content', level_id='$level' ")or die(mysql_error());
...
<table width="750" border="0" align="center">
	...
	<tr>
			<td>Fullname</td>
			<td>:</td>
	  <td><input name="fullname" type="text" size="30" required></td>
    </tr>
	...
	<tr>
	  		<td>IC</td>
	  		<td>:</td>
	  		<td><input name="noic" type="text" size="30" required></td>
            <td width="223"></tr>
	...
	<tr>
			...
			<td>:</td>
			<td>
		      <input name="nama" type="text"  size="30" required />
		    </td>
			<td>(P&lt;icnumber&gt;) - for student</br>
            (G&lt;icnumber&gt;) - for teacher</td>
    </tr>
   ...
   <?php /*?> <tr>
	...
	<tr>
			...
			<td> <select name="level"  onchange="showP_class(this.value)" required>
                 ...
                 <td>
                <?php /*?> <div id="showClass">
		<select style="width:145px;font-family:calibri;font-weight:bold;color:blue" onchange="submit()" name="class" id="class">
	...
	<?php /*?><tr>
     		<td height="26">Class</td>
      		<td> :</td>
      		<td><select style="width:145px;font-family:calibri;font-weight:bold;color:black" onchange="submit()" name="class" id=    	    "class" required>
              <option value="" selected="selected" style="color: black;">-</option>
            </select></td>
	</tr>
	<?php */?>
	<tr>
				...
				<td>:</td>
				<td> <input type="file" name="photo" size="35" value="No file choosen" /></td>
