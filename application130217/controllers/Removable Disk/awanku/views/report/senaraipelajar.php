...
<?php
$id = $_POST['id'];
$r = mysql_query("Select * from tbl_userinfo where class_id='$id' flag= '1'");
...
<?php
$bil=0;
$q="select * from tbl_userinfo where class_id='$id' and flag='1'";
$r=mysql_query($q);
while($classroom=mysql_fetch_array($r)){
?>
<tr>
  <td style="padding: 1px;" align="center"><?php echo $bil+1; ?></td>
  <td style="padding: 3px;" align="center"><a href="<?php echo base_url('index.php/report_control/student_list?class_id='.$classroom["id"].''); ?>"><?php echo $classroom["fullname"]; ?></a></td>
</tr>
<?php
$bil++;
}
